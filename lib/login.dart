...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    final greeting = localizedStrings[widget.currentLang]!['greeting'] ?? 'Hello!';
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: const Color.fromRGBO(255, 122, 0, 1)),
                      ),
                      child: Row(
                        children: [
                          ...
                          Text(
                            lang.toUpperCase(),
                            style: TextStyle(
                              color: isSelected ? Colors.white : const Color.fromRGBO(255, 122, 0, 1),
